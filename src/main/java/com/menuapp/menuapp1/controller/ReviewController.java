...
public class ReviewController {
    ...
    @Operation(
            summary = "Leave a Review For a Particular Book REST API",
            description = "Leave a Review REST API is used to save a Review for a particular Book in the database"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            summary = "Find All Reviews For a Particular Book REST API",
            description = "Find All Reviews REST API is used to fetch all the reviews for a particular book from the database"
    )
    @ApiResponse(
            responseCode = "200",
